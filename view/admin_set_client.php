...
<body>
    ...
    <ul class="sidebar" >
        ...
        <li class="sidebar-list"><a class="active" href="admin_set_client.php">Set Client</a></li>
...
<!-- container -->
<div class="container">
    <form action="../php/admin_ClientblockService.php" method="post">   
        <p class="table-header">Client Set</p>  
