...
<head>
    ...
    <title>E-Pocket Banking System - Manager - Home</title>
     <link rel="stylesheet" type="text/css" href="../assets/css/manager/bonousStyle.css">
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="catagory">
                ...
                <ul>
                 ...
                 <form action="../php/client_bonous.php" method="post" class="my-form">
                   
                 <div class="form-group">
             
                    
                    <u><h3>Client Bonous</h3></u>
                    <label for=""> Account Id :  </label>
                     <input type="text" name="c_accountNumber"><br><br>
                 </div>
                 <div class="form-group">
                    <label for=""> Amount :  </label>
                     <input type="number" name="c_bonousAmount" > BDT <br><br>
                 </div>
                    <input type="submit" name="c_bonous" value="Proceed" class="button">
             
                           <div class="form-group">
                                          <u><h3>Co-Client Bonous</h3></u>
                                <label for=""> Account Id :  </label>
                             <input type="text" name="co_accountNumber"><br><br>
                            </div>
                              <div class="form-group">
                                  <label for=""> Amount :  </label>
                     <input type="number" name="co_bonousAmount" > BDT <br><br>
                 </div>
                    <input type="submit" name="co_bonous" value="Proceed" class="button">
