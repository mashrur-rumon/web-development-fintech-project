...
<head>
    ...
    <title>E-Pocket Banking System - Manager - Home</title>
     <link rel="stylesheet" type="text/css" href="../assets/css/manager/promotionStyle.css">
</head>
<body>
        ...
        <u><h1>E-Pocket Banking System</h1></u>
         ...
         <div class="catagory">
                ...
                <ul>
                 ...
                 <form action="../php/stopPromotion.php" method="post"  class="my-form">
                    ...
                    <input type="submit" name="stopPromotion" value="Stop" class="button">
                </form>
