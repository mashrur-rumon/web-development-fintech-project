...
<body>
    ...
    <ul class="sidebar" >
        ...
        <li class="sidebar-list"><a class="active"href="admin_limit_voucher.php">Limit Voucher</a></li>
    ...
    <!-- container -->
    <div class="container">
    <form action="../php/admin_limit_vouchar.php" method="post">
        <p class="table-header">New Vouchar</p>
